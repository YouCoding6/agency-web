...
const Navbar = () => {
    ...
    return (
        <div className="row align-items-center space-between text-center p-3">
            ...
            <div className="col-md-3">
                <Link className="nav-link link" to="/works">Works</Link>
            </div>

            <div className="col-md-1">
                {displayMode.mode === 'day' ?
                    <div className="button" onClick={displayMode.nightMode}>
                    ...
                    <div className="button" onClick={displayMode.dayMode}>
